...
public class ConnexionJV {
    ...
    public  static  void main (String[] args) {
       try {
         ...
         System.out.println("Suppression d'une base de données ...");
         smt.executeUpdate("DROP DATABASE dbemploye");
         System.out.println("La base de données dbemploye supprimée avec succés...");
